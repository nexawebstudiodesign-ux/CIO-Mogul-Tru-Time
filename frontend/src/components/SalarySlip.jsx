            ...
            <div className="salary-slip-container p-8 md:p-10">
              ...
              <div className="slip-section rounded-xl border border-sand-200 overflow-hidden print-reduce-sm">
                ...
                <div className="bg-white">
                  <div className="grid grid-cols-2 border-b border-sand-200 font-semibold">
                    <div className="px-3 py-2 text-[10px] text-ink-500 border-r border-sand-200 print-text">
                      Pay Period
                    </div>
                    <div className="px-3 py-2 text-xs text-ink-500 print-text">
                      {monthYear}
                    </div>
                  </div>
                  <div className="grid grid-cols-2 border-b border-sand-200 font-semibold">
